...
(function () {
    ...
    const { META, SIDEBAR_NAV, QUIZZES } = Chapter5Data;
    ...
    function renderPage() {
        ...
        if (!app) return;
        app.innerHTML = Chapter5Data.getContent();
    }
